...
4. Focuses on the alice-analyst-test user for simplified processing
"""
...
def load_configuration() -> Dict[str, str]:
    ...
    try:
        ...
        response = ssm.get_parameter(Name='github-token', WithDecryption=True)
...
def build_response(
    ...
    Args:
        ...
        detailed_findings_count: Number of detailed findings fetched
        recommendations: Policy recommendations generated
        pr_created: Whether PR was created successfully
...
def lambda_handler(event: dict, context: LambdaContext) -> dict:
    ...
    2. Analyze IAM resources and Access Analyzer findings
    3. Generate policy recommendations for unused permissions
    4. Create GitHub PR with Terraform policy updates
